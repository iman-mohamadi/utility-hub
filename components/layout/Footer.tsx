  ...
  return (
    <footer className="mt-auto border-t bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            <div className="mb-4 flex items-center gap-2">
              <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-linear-to-br from-blue-500 to-blue-700">
        ...
        <div className="mt-8 flex items-center justify-between border-t pt-8 text-center text-sm text-muted-foreground">
          <p>
            © {new Date().getFullYear()} ابزارهای رایگان - تمامی حقوق محفوظ است
          </p>
          <p>
            ساخته شده توسط{" "}
            <a href="https://iman-mhmdi.ir" target="_blank" className="text-sky-400 hover:text-sky-500">
              ایمان
            </a>
          </p>
        </div>
